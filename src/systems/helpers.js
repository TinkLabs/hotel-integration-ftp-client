  ...
  return records.map(record => {
    ...
    let result = {
      reservation: {
        ...
        actual_checkin_date: !empty(record.actual_checkin_date) ? record.actual_checkin_date : "",
        actual_checkout_date: !empty(record.actual_checkout_date) ? record.actual_checkout_date: "",
        booking_date: !empty(record.booking_date) ? record.booking_date : "",
        cancel_date: !empty(record.cancel_date) ? record.cancel_date : "",
